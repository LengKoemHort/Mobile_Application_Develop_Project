...
class ListFoodAdapter(private val items: ArrayList<Foods>) : RecyclerView.Adapter<ListFoodAdapter.ViewHolder>() {

    private lateinit var context: Context

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        context = parent.context
        val inflate = LayoutInflater.from(parent.context).inflate(R.layout.viewholder_list_food, parent, false)
